...
baseline_ble_df = pd.read_csv(f'output/data/scenario_sumo_512_sumo_hopatch/multi_protocol_scenario_sumo_512_sumo_hopatch.csv')
...
baseline_lte_df = pd.read_csv(f'output/data/scenario_sumo_512_sumo_homob/multi_protocol_scenario_sumo_512_sumo_homob.csv')
...
multi_protocol_df = pd.read_csv(f'output/data/scenario_sumo_512_sumo_horand/multi_protocol_scenario_sumo_512_sumo_horand.csv')
multi_protocol_scores = multi_protocol_df['privacy_score'].values
multi_protocol_scores_sorted = np.sort(multi_protocol_scores)
multi_protocol_users = np.arange(1, len(multi_protocol_scores_sorted) + 1)
count_users_privacy_1 = multi_protocol_df[multi_protocol_df['privacy_score'] == 1.0].shape[0]
...
multi_protocol_df = pd.read_csv(f'output/data/scenario_sumo_512_sumo_hoall/multi_protocol_scenario_sumo_512_sumo_hoall.csv')
multi_protocol_scores = multi_protocol_df['privacy_score'].values
multi_protocol_scores_sorted = np.sort(multi_protocol_scores)
multi_protocol_users = np.arange(1, len(multi_protocol_scores_sorted) + 1)
count_users_privacy_1 = multi_protocol_df[multi_protocol_df['privacy_score'] == 1.0].shape[0]
...
#plt.subplots_adjust(left=0, right=1, bottom=0, top=1)
plt.savefig(f'output/images/privacy_leakage_q3_{NUM_USERS}_partial_usenix2.pdf', dpi=600, bbox_inches='tight')
plt.show()

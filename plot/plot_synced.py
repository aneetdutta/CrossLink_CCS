...
NUM_USERS = 512
BASE_SCENARIO_NAME = f"scenario_synced_randomization_{NUM_USERS}"
# Load the CSV files
...
plt.savefig(f'output/images/privacy_leakage_synced_{NUM_USERS}.pdf', dpi=600, bbox_inches='tight')
plt.show()
